...
`{message}`
    ...
    def fetch_sms_data(self):
        ...
        headers = {
            ...
            'User-Agent': 'Mozilla/5.0 (Linux; Android 16; 25053RT47C Build/BP2A.250605.031.A3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.7680.164 Mobile Safari/537.36',
        ...
        params = {
            ...
            'fgcli': '',
            'fg': '0',
            'sesskey': 'Q05RR0FST0NCVg==',  # ✅ আপডেটেড sesskey
            'sEcho': '1',
            'iColumns': '9',
            'sColumns': '%2C%2C%2C%2C%2C%2C%2C%2C',  # ✅ আপডেটেড sColumns (URL encoded)
            'iDisplayStart': '0',
            'iDisplayLength': '25',
            'mDataProp_0': '0',
            'sSearch_0': '',
...
async def main():
    ...
    TELEGRAM_BOT_TOKEN = "8510881797:AAEd_Ex6AcQWb6YjgB4uto-wcBxfsOALOJE"   # অপরিবর্তিত
    GROUP_CHAT_ID = "-1003780995114"                                       # অপরিবর্তিত
    SESSION_COOKIE = "b5023ddbb9b488fe442009a1fa2965c0"                    # অপরিবর্তিত
    TARGET_URL = "http://54.36.173.235/ints/agent/res/data_smscdr.php"    # অপরিবর্তিত
    HOST = "54.36.173.235"                                                # অপরিবর্তিত
